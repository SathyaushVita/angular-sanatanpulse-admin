...
@Component({
  selector: 'app-stagingupdate',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './stagingupdate.component.html',
  styleUrl: './stagingupdate.component.css'
})
export class StagingupdateComponent {
  ...
  onSubmit(): void {
    if (this.editForm.valid) {
      ...
      this.adminService.UpdateNewsStaging(this.newsId, this.editForm.value).subscribe(
        response => {
          console.log('News updated successfully:', response);
          this.editForm.reset();
          this.audioBase64 = '';  // or null depending on your requirement
          this.profileImage = ''; // or null depending on your requirement
