...
@Component({
  selector: 'app-productionedit',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './productionedit.component.html',
  styleUrl: './productionedit.component.css'
})
export class ProductioneditComponent {
  ...
  onSubmit(): void {
    if (this.editForm.valid) {
      ...
      this.adminService.EditNewsProduction(this.newsId, this.editForm.value).subscribe(
        response => {
